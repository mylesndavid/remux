...
final class MenuBarExtraController: NSObject, NSMenuDelegate {
    ...
    private let showMainWindowItem = NSMenuItem(title: String(localized: "statusMenu.showCmux", defaultValue: "Show remux"), action: nil, keyEquivalent: "")
    ...
    private let quitItem = NSMenuItem(title: String(localized: "menu.quitCmux", defaultValue: "Quit remux"), action: nil, keyEquivalent: "")
